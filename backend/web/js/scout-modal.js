...
(function () {
  ...
  var CSS = [
    ...
    'border:1px solid var(--border,#1f1f1f);border-radius:var(--radius,12px);max-width:520px;width:100%;',   /* the ONE dialog shell (D-6, 2026-09-03) — see .kb-modal-dialog in dashboard.html */
    'padding:28px;box-shadow:0 18px 50px rgba(0,0,0,0.5);font-size:14px;line-height:1.5;}',
    '.scout-modal-title{margin:0 0 10px;font-size:16px;font-weight:var(--fw-emphasis,500);color:var(--text,#ededed);}',
    ...
    'border:1px solid var(--border-strong,#333);border-radius:var(--radius-sm,8px);font-size:14px;}',
    ...
    '.scout-modal-btn{padding:8px 14px;border-radius:var(--radius-sm,8px);font-size:var(--fs-secondary,13px);cursor:pointer;',
    'background:var(--bg-field,#0d0d0d);color:var(--text,#ededed);',
