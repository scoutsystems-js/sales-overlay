...
function render(stateOverrides, options) {
  ...
  else if (stateOverrides.view === 'team-objections') api.renderApp();
...
function overviewBase(overrides) { return Object.assign({ view: 'overview', me: { user_id: 'rep-1', role: 'manager' }, viewingUserId: 'rep-1', dateRange: { from: '2026-09-01T00:00:00.000Z', to: '2026-09-30T23:59:59.999Z' }, analytics2: OVERVIEW_ANALYTICS, analytics2Loading: false, gradingBacklog: { graded: 12, waiting: 0, total: 12 }, needsWork: OVERVIEW_NEEDS_WORK, needsWorkLoading: false, sectionRank: OVERVIEW_SECTION_RANK, sectionRankLoading: false, fathomStatus: { connected: true, last_sync_status: 'ok' }, zoomStatus: { connected: false }, repGraph: null, repGraphLoading: false, overviewExpanded: { coach: false, perf: false, recent: false } }, overrides || {}); }
