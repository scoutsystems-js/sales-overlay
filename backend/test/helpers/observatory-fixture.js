...
const OVERVIEW_OBJECTION_SYNTHESIS = { available: true, categories: [{ category: 'fear', grounded: true, isolate: 'Clarify the real concern before answering it.', reframe: 'Connect the concern back to the outcome they want.', overcome: 'Test whether resolving that concern clears the way to decide.', what_worked: 'You slowed down, named the concern, and tested whether it was the only thing holding them back.' }] };
...
function overviewBase(overrides) { return Object.assign({ view: 'overview', me: { user_id: 'rep-1', role: 'manager' }, viewingUserId: 'rep-1', dateRange: { from: '2026-09-01T00:00:00.000Z', to: '2026-09-30T23:59:59.999Z' }, analytics2: OVERVIEW_ANALYTICS, analytics2Loading: false, gradingBacklog: { graded: 12, waiting: 0, total: 12 }, needsWork: OVERVIEW_NEEDS_WORK, needsWorkLoading: false, objectionsSynthesis: OVERVIEW_OBJECTION_SYNTHESIS, sectionRank: OVERVIEW_SECTION_RANK, sectionRankLoading: false, fathomStatus: { connected: true, last_sync_status: 'ok' }, zoomStatus: { connected: false }, repGraph: null, repGraphLoading: false, overviewExpanded: { coach: false, perf: false, recent: false } }, overrides || {}); }
