...
const OVERVIEW_OBJECTION_SYNTHESIS = { available: true, categories: [{ category: 'fear', grounded: true, practice: 'Clarify the real concern before answering it.', review_example: { call_id: 'focus-call-1', prospect_name: 'Morgan Blake', call_date: '2026-09-16T15:00:00.000Z', outcome: 'closed', closer_response: 'What would need to be true for you to feel ready to move forward?' } }] };
