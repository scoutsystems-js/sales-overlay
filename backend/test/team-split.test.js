...
test('every panel is assigned to exactly one page', () => {
  ...
  /* 5 → 6 on 2026-09-04: 'missed' (H722), renamed 'coachable' the same day (H726). ADDING a
...
test('⚠ the panel KEYS are unchanged — that is the Customize View migration', () => {
  ...
  assert.deepStrictEqual(keys,
    ['coachable', 'digest', 'gauges', 'graphs', 'recs', 'reps'],   // 'missed' (H722, one day old) became 'coachable' (H726) when missed signals ceased to be its own section — a stored hidden 'missed' is discarded on read
