...
test('pairSentence is assembled from the two ends and the gap and states no principle', () => {
  ...
  assert.strictEqual(s, 'At 00:03:03 the prospect said "I invested money in things that did not work out". The closer replied "I am not just a salesperson" and moved on. The signal was not explored. 36 min later, at 00:39:48, the prospect said "even 20 grand, I do not have it" — a disqualification.');
  assert.ok(!/foreshadow/.test(s), 'no causal claim the data does not carry (H722)');
