...
const reps=[{user_id:'a',name:'Ava',calls:1,period_summary:P.summarize([{id:'call',call_date:example.call_date,analysis_status:'done',analysis:assessed({intro_score:55,discovery_score:40,pitch_score:70,close_score_earned:54}),period_review_current:true}],[example],window)},{user_id:'b',name:'Ben',calls:0,period_summary:P.summarize([],[],window)}];
