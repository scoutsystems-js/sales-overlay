...
function page(reps) {
  const funcs = ['scoreColor', 'ymd', 'dayLabel', 'rangeLabelInclusive', 'coachingRepName', 'coachingRepWorkspaceHtml', 'coachingPeriodWorkspaceHtml', 'coachingPeriodExampleHtml','coachingExchangeHtml','coachingExchangeSegments','coachingExchangeGapLabel', 'selectCoachingRep'].map(n => fnBody(live, n)).join('\n');
