...
function buildHighlightExtractorPrompt(normalized) {
  ...
  return [
    ...
    '  - closer_response: the closer\'s actual words responding to it — a contiguous verbatim span from ONE of the closer\'s transcript lines, copied exactly per the HOW TO QUOTE rules above. Use null if the closer never responded, or if you cannot produce an exact span.',
