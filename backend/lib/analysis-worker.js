...
function buildSectionGraderPrompt(normalized, durationSeconds) {
  ...
  return [
    ...
    '  1. INTRO       — opening, rapport, agenda-setting',
    '  2. DISCOVERY   — pain, goals, timeline, budget, decision-maker surfacing',
    ...
    '  5. CLOSE       — asking for the decision + handling final concerns',
    '',
    ...
    '  - overall_summary: 2-3 sentences capturing the call\'s arc and apparent outcome',
    ...
    '  - follow_up_email: a draft the closer can copy + send today. Reference specific moments from this call. First-person, conversational, under 200 words.',
    '',
...
function buildHighlightExtractorPrompt(normalized) {
  ...
  return [
    ...
    '  - observation: one factual sentence describing what happened (not commentary, not validation, no "great job" or "should have done X")',
