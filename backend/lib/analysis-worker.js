...
const ANALYSIS_PROMPT_VERSION = 'v57-2026-09-07'; // v57: the evidence bounds stated once for stage records (1-4) and context facts (unbounded), from the validator's own constants; a bad context field withholds only the stages that read it. v56: the normal grader is the sole source for validated five-stage eligibility and canonical A+–F scores. v55: unambiguous call-ending wording. v54: exact action/answer records instead of prior interpretations. v53: sentence-by-sentence evidence review. v52: one compact coaching brief, 45–65 word target. v51: scope/length preflight and original review IDs. v50: observed continuation without invented causation.
