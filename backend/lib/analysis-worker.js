...
function buildSectionGraderPrompt(normalized, durationSeconds, sellingContext, coachingAreas, opts) {
  ...
  var lines = [
    ...
    /* Block 006: the five definitions are Justin's and live ONCE, in stage-eligibility.STAGE_DEFINITIONS; printed here verbatim. */
    '  1. ' + stageEligibility.STAGE_DEFINITIONS.intro,
    '  2. ' + stageEligibility.STAGE_DEFINITIONS.discovery,
    '  3. ' + stageEligibility.STAGE_DEFINITIONS.pitch,
    '  4. ' + stageEligibility.STAGE_DEFINITIONS.objection,
    '  5. ' + stageEligibility.STAGE_DEFINITIONS.close,
    '',
    stageEligibility.STAGE_BOUNDARIES,
    '',
