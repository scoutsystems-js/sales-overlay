...
const ANALYSIS_PROMPT_VERSION = 'v56-2026-09-07'; // v56: the normal grader is the sole source for validated five-stage eligibility and canonical A+–F scores. v55: unambiguous call-ending wording. v54: exact action/answer records instead of prior interpretations. v53: sentence-by-sentence evidence review. v52: one compact coaching brief, 45–65 word target. v51: scope/length preflight and original review IDs. v50: observed continuation without invented causation.
...
function buildSectionGraderPrompt(normalized, durationSeconds, sellingContext, coachingAreas, opts) {
  ...
  var lines = [
    ...
    '',
    'STAGE ASSESSMENT — this is the sole source for stored stage scores. Return exactly five records: intro, discovery, pitch, objection_handling, close. For each record return state, whole-number score/grade only when gradeable, 1-4 strong transcript turn identifiers, and a short plain-language reason. Never copy or reconstruct a quote: cite the turn identifiers and code will attach the actual speaker, timestamp, and text.',
