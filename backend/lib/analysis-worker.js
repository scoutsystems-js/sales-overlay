...
const ANALYSIS_PROMPT_VERSION = 'v46-2026-09-05'; // v46 (H733): the manager's notes ride under the doctrine entries they speak to; a disqualified prospect is never a lost deal in the coaching prompt. Was v45-2026-09-05
...
async function coachCallMoments(admin, fathomCallId, outcome, later, objectionNotes, userId) {
  ...
  var prompt = coachingLib.buildCoachingPrompt(moments, { outcome: outcome, later: later, dq: callHasDq,
