...
async function coachCallMoments(admin, fathomCallId, outcome, later, objectionNotes, userId) {
  ...
  var prompt = coachingLib.buildCoachingPrompt(moments, { outcome: outcome, later: later, dq: callHasDq, historyBlock: coachHistory.historyBlock(history, coachedBefore),
