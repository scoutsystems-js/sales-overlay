...
async function loadPeriodMaterial(admin,opts={}) {
 const material=await loadKbMaterial(admin,{...opts,lane:'rep-period',maxChars:MAX_CHARS,sellingOptions:{completeScript:true,legacyBudget:2500}});
 ...
 return {...material,sourceMode:'complete_documents'};
}
