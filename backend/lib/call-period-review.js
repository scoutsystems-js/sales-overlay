...
const VERSION='call-period-review-v6';
...
function writerPrompt(context,material,outcome){return [
 ...
 'Each finding needs THREE TO TEN exact transcript turn IDs, including both speakers: the disclosure, the closer response, and what followed. These IDs produce the real excerpts on the page. Select the most informative exchange, not an unrelated ending. A manager will see the quoted evidence. Cite applicable knowledge IDs. Do not coach an assumed rule that is absent from the supplied knowledge.',
...
module.exports={ALL_MOVES,VERSION,MAX_TOKENS,prepare,writerPrompt,candidates,reviewPrompt,finish,storedExamples,applySchedulingFacts,schedulingPrompt};
