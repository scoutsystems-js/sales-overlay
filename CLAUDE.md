...
#### v1.4 Team Layer — IN PROGRESS (approved 2026-07-21; stages 1–2 shipped, STOPPED at checkpoint)
...
- **NEXT (not started — stopped for Justin's manager-view review):** Stage 4 admin console rebuild; Stage 4 admin console rebuild (+ `managed_by`/`billing_status` PATCH, invite); Stage 5 frontend (Team view, console, account page). Full design + permissions matrix in the approved design doc (this session).
