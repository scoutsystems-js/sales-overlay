...
**Approved replacement design — 2026-09-12:** Justin selected Observatory as the new site standard, superseding Polished HUD and the earlier Stark mockup. [site-design.md](site-design.md) records the exact approved styling, the central score instrument beside Coaching Focus, and the archived source with its embedded Saira font. Atelier remains an unapproved exploration. The approved visual changes supersede the older appearance below for the redesign; this file's existing tokens and guards still describe production until implementation. This approval does not change product behavior, metric definitions, or permissions. The redesign is saved, not deployed. The Performance page was also approved on 2026-09-12; its exact archive and page-specific layout are recorded in site-design.md.

**Observatory implementation scope — 2026-09-13:** the approved Observatory tokens, page shapes, central score instrument, Coaching Focus treatment and Performance presentation apply only to Team → Coaching and Team → Performance. These are scoped page exceptions within the existing system; every other dashboard page keeps its current production treatment until separately approved.
