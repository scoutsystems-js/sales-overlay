...
Final correction from live verification: remove the older unreviewed grader outcome explanation from improvement evidence only. Coaching approval never certified that extra paragraph. Retain recorded outcome and exact continuation; keep source data intact. Regression failed before the correction. Final release verification pending.
