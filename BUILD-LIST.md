...
| **Nav shows the wordmark, not just "Scout"** | The nav renders the text "Scout"; it should carry the logo lockup | ⚠⚠ **STILL BLOCKED, AND NOW WITH A MEASURED FLOOR (2026-08-21).** The logo asset's smallest dot is **8px at its native 1038px width**, so it scales to **2.5px at the welcome overlay's 327px** and **under 1px below a ~120px render** — the mark stops resolving long before nav size, exactly as the filed ruling predicted. **DO NOT put this asset in the nav at any size.** A nav variant needs the mark REDRAWN with fewer, thicker elements (drop the inner rings, one dot), not this artwork scaled. ⚠ Same construction limit already bites the welcome title below ~618px vmin, where its smallest dot goes under 2px |
